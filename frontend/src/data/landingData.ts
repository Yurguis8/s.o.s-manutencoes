...
export const PLANS: Plan[] = [
  {
    ...
    totalAnnual: 430.80,
    benefitsSemiannual: [
      "Primeira inspeção em até 20 dias",
      "2 inspeções preventivas no semestre",
    ...
    benefitsAnnual: [
      "Primeira inspeção em até 20 dias",
      "4 inspeções preventivas no ano",
      "Manutenção básica (portas, gavetas, dobradiças e corrediças)",
      "Aperto de parafusos e lubrificação de ferragens",
      "Mão de obra gratuita em pequenos reparos",
      "Kit de limpeza de brinde",
  ...
  },
  {
    ...
    isPopular: true,
    benefitsSemiannual: [
      "Primeira inspeção em até 15 dias",
      "3 inspeções preventivas no semestre",
      ...
      "Relatório digital da vistoria",
      "Diagnóstico por WhatsApp",
      "Participação em 3 sorteios no período",
      "15% de desconto em grandes serviços"
    ],
    benefitsAnnual: [
      "Primeira inspeção em até 15 dias",
      "6 inspeções preventivas no ano",
      "Todos os serviços de manutenção e reparo do Essencial",
      "Atendimento prioritário em até 24h",
      "Orçamento presencial gratuito para novos projetos",
      "Kit de limpeza de brinde",
  ...
  },
  {
    ...
    totalAnnual: 1078.80,
    benefitsSemiannual: [
      "Primeira visita em até 10 dias",
      "4 inspeções preventivas no semestre",
      ...
      "Relatório digital da vistoria",
      "Diagnóstico por WhatsApp",
      "Participação em 6 sorteios no período",
      "20% de desconto em grandes serviços"
    ],
    benefitsAnnual: [
      "Primeira visita em até 10 dias",
      "8 inspeções preventivas no ano",
      "Todos os serviços de manutenção e reparo do plano Casa",
      "Prioridade máxima na agenda de atendimento",
      "Consultoria técnica para grandes projetos",
      "Kit de limpeza de brinde",
...
export const HARDWARE_PRODUCTS: HardwareProduct[] = [
  {
    id: 'kit-nichos-3',
    name: 'Kit de Nichos - 3 Unidades',
    description: 'Conjunto com 3 nichos decorativos organizadores.',
    price: 69.99,
    sku: 'FER-001',
    category: 'Decoração',
    imageUrl: '',
  ...
  {
    id: 'banqueta-tripe-redonda',
    name: 'Banqueta Tripé Redonda',
    description: 'Banqueta com design tripé e assento redondo, ideal para diversos ambientes.',
    price: 99.99,
    sku: 'FER-002',
    category: 'Móveis',
    imageUrl: '',
  ...
  {
    id: 'porta-chave-decorativo',
    name: 'Porta Chave Decorativo',
    description: 'Organizador e porta-chaves decorativo para parede.',
    price: 35.99,
    sku: 'FER-003',
    category: 'Decoração',
    imageUrl: '',
  },
  {
    ...
    description: 'Conjunto de acessórios organizadores para banheiro.',
    price: 49.99,
    sku: 'FER-004',
    category: 'Acessórios',
    imageUrl: '',
  ...
  {
    id: 'kit-prateleira-2',
    name: 'Kit de Prateleira - 2 Unidades',
    description: 'Conjunto com 2 prateleiras para organização e exposição.',
    price: 49.99,
    sku: 'FER-005',
    category: 'Decoração',
    imageUrl: '',
  ...
  {
    id: 'tabua-apresentacao-teca-resina',
    name: 'Tábua de Apresentação em Madeira Teca com Resina',
    description: 'Tábua de madeira teca com acabamento exclusivo em resina efeito mar.',
    price: 49.99,
    sku: 'FER-006',
    category: 'Cozinha',
    imageUrl: '',
