      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="bg-surface-card border border-border rounded-xl p-8 sm:p-14 shadow-xl shadow-black/20">
          ...
          <div className="max-w-3xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10 pt-8 border-t border-border">
              {[
            ...
            <div className="flex items-center">
              <button
                ...
                className="px-6 py-3 rounded-lg bg-brand hover:bg-brand-hover text-white font-medium text-sm transition-all duration-150 cursor-pointer flex items-center gap-2 shadow-md shadow-brand/20"
              >
