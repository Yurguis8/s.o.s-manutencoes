        ...
        <Reveal className="max-w-3xl mx-auto flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 w-full sm:w-auto">
            <button
              ...
              className="w-full sm:w-auto px-6 py-3.5 rounded-lg bg-white hover:bg-white/90 text-brand font-semibold text-sm transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer shadow-lg"
            >
            ...
            <a
              ...
              className="w-full sm:w-auto px-6 py-3.5 rounded-lg bg-transparent hover:bg-white/10 text-white font-medium text-sm border border-white/30 transition-all duration-300 flex items-center justify-center cursor-pointer"
            >
